...
-- ============================================================
-- BUILD INFO STRING — mirip screenshot: "Relic: 0 • Players: 3/20 • Windy"
-- ============================================================
local function getNextSunkenIn(uptimeSec)
    if not uptimeSec or uptimeSec == 0 then return nil end
...
local function buildCard(s, idx)
    ...
    local sunkenStr = s.uptimeSeconds and s.uptimeSeconds > 0 and getNextSunkenIn(s.uptimeSeconds)
    if sunkenStr then
